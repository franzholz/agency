...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/' . AGENCY_EXT . '/scripts/class.tx_agency_dmstatic_dmstatic.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/' . AGENCY_EXT . '/scripts/class.tx_agency_dmstatic.php']);
}
